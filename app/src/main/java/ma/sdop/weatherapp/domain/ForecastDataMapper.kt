...
import ma.sdop.weatherapp.domain.Forecast as ModelForecast
...
class ForecastDataMapper {
    ...
    private fun convertForecastLstToDomain(list: List<Forecast>): List<ma.sdop.weatherapp.domain.Forecast> {
    ...
    private fun convertForecastItemToDomain(forecast: Forecast): ma.sdop.weatherapp.domain.Forecast {
        return ma.sdop.weatherapp.domain.Forecast(convertDate(forecast.dt), forecast.description, forecast.temp.max.toInt(), forecast.temp.min.toInt(), generateIconUrl(forecast.icon))
    }
